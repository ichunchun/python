...
excel4 = pd.read_excel("excel4.xlsx")
excel5 = pd.read_excel("excel5.xlsx")
excel6 = pd.read_excel("excel6.xlsx")


# 合并三个Excel
df = pd.concat([excel1, excel2, excel3, excel4, excel5, excel6])
